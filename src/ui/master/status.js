...
class Status extends React.Component{
  ...
  selectStatus = e => {
    ...
    this.setState({ name: Name, id: IDStatus});
  }
  ...
  saveStatus = e => {
    ...
    if(id) {
      let form = { Name: name };
      let url = `${API_URL}/api/project_status/${id}`;
      ...
      axios.post(url, form).then( res => {
        toast.success(`New status has been saved`)
        this.fetchStatus();
        this.clearForm();
      })
    }
  ...
  deleteStatus = e => {
    ...
    axios.delete(url).then( res => {
      toast.error('Status has been deleted')
      this.fetchStatus()
    })
  }
                  ...
                  <div class="card-body">
                    <form onSubmit={this.saveStatus}>
                      <div class="form-group">
                        <label>Name</label>
                        <input required onChange={e => this.setState({ name: e.target.value })} value={this.state.name} type="text" class="form-control" />
                      </div>
                      <div class="form-group">
